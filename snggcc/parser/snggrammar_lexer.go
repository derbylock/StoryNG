...
var snggrammarlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func snggrammarlexerLexerInit() {
	staticData := &snggrammarlexerLexerStaticData
...
// snggrammarLexerInit initializes any static state used to implement snggrammarLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewsnggrammarLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SnggrammarLexerInit() {
	staticData := &snggrammarlexerLexerStaticData
	staticData.once.Do(snggrammarlexerLexerInit)
}

// NewsnggrammarLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewsnggrammarLexer(input antlr.CharStream) *snggrammarLexer {
	SnggrammarLexerInit()
	l := new(snggrammarLexer)
	...
	l.GrammarFileName = "snggrammar.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// snggrammarLexer tokens.
const (
	snggrammarLexerT__0    = 1
	snggrammarLexerT__1    = 2
	snggrammarLexerT__2    = 3
	snggrammarLexerT__3    = 4
	snggrammarLexerT__4    = 5
	snggrammarLexerT__5    = 6
	snggrammarLexerNEWLINE = 7
	snggrammarLexerINT     = 8
)
